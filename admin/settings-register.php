...
function pressable_cache_management_register_settings(): void {
	...
	register_setting(
		...
		PCM_Options::MAIN_OPTIONS->value,
		array(
			'sanitize_callback' => 'pressable_cache_management_callback_validate_options',
		)
	);
	...
	register_setting(
		...
		array(
			'sanitize_callback' => 'edge_cache_settings_tab_callback_validate_options',
		)
	);
	...
	register_setting(
		...
		PCM_Options::REMOVE_BRANDING_OPTIONS->value,
		array(
			'sanitize_callback' => 'remove_pressable_branding_tab_callback_validate_options',
		)
	);
	...
	add_settings_field(
		...
		array(
			...
			'label' => esc_html__( 'Hide or show plugin branding', 'pressable_cache_management' ),
		)
	);
}
