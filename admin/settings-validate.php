...
function pressable_cache_management_callback_validate_options( array $input ): array {
	...
	$input['flush_batcache_for_woo_product_individual_page_checkbox'] = ! empty( $input['flush_batcache_for_woo_product_individual_page_checkbox'] ) ? 1 : 0;
