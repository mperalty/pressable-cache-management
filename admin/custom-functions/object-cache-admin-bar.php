...
function pcm_abar_flush_object_callback(): void {
	...
	pcm_cache_service()->flush_object_cache( 'admin-bar-object-flush' );
...
function pcm_abar_purge_edge_callback(): void {
	...
	if ( pcm_cache_service()->purge_edge_cache_domain( 'admin-bar-edge-purge' ) ) {
...
function pcm_abar_add_menu( \WP_Admin_Bar $wp_admin_bar ): void {
	...
	$branding_disabled = is_array( $branding_opts )
