...
if (isset($options['cache_wpp_cookies_pages']) && !empty($options['cache_wpp_cookies_pages']))
{
    ...
    update_option( PCM_Options::CACHE_WPP_COOKIES_PAGES, $options['cache_wpp_cookies_pages']);
    ...
    function pcm_cache_wpp_cookies_pages_admin_notice()
    {
        ...
        $cache_wpp_cookies_pages_activate_display_notice = get_option( PCM_Options::CACHE_WPP_COOKIES_PAGES_NOTICE, 'activating');
        ...
        if ('activating' === $cache_wpp_cookies_pages_activate_display_notice && current_user_can('manage_options'))
        {
            ...
            update_option( PCM_Options::CACHE_WPP_COOKIES_PAGES_NOTICE, 'activated');
...
else
{
    ...
    update_option( PCM_Options::CACHE_WPP_COOKIES_PAGES_NOTICE, 'activating');
