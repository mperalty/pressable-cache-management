 ...
 *
 * When enabled, copies the Batcache manager mu-plugin source into mu-plugins so that Batcache
...
$mu_plugin_src  = plugin_dir_path( __FILE__ ) . 'class-batcache-manager.php';
...
if ( $enabled ) {
	...
	// class-batcache-manager.php (e.g. targeted flush fixes) take effect immediately.
